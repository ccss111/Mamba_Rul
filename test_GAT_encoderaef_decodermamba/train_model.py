...
from dataset import *
from test_GAT_encoderaef_decodermamba import *
from utils import *
...
if __name__ == '__main__':
    ...
    for num in seed_sequence:
        ...
        model = EncoderDecoder(encoder=encoder, decoder=decoder,  use_spatial_gat=args.use_spatial_gat, gat_hidden_dim=args.gat_hidden_dim)
        ...
        with open(log_path, "a", encoding="utf-8") as f:
            ...
            f.write(f"use_gat: {model.use_spatial_gat}\n")
        ...
        auto_test_cmd = [
            sys.executable,
            os.path.join(parent_dir, 'test_GAT_encoderaef_decodermamba', 'test_model.py'),
